...
public class HumanTownBuilding : BuildingBase
{
    ...
    public void HumanWorker(bool asButton, Transform[] spawnPoints)
    {
        ...
        go.GetComponentInChildren<TMP_Text>().text = "Peasant";
        ...
        go2.GetComponentInChildren<TMP_Text>().text = "Peasant";
        go2.GetComponent<HumanWorkerUnit>().enabled = true;
